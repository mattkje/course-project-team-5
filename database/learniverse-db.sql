...
VALUES ('john_doe', 'john.doe@example.com', '$2a$10$v8zrek0TRlIUCME2Na10DeeiIBiHD1gpAeEU5m9FzIpw4C/YABf9O', 'John', 'Doe', 1, true, '2024-02-12', '2024-02-12',
       ...
       ('jane_smith', 'jane.smith@example.com', 'smithpassword', 'Jane', 'Smith', 2, true, '2024-02-12', '2024-02-12',
        '+1987654321'),
       ('bob_johnson', 'bob.johnson@example.com', 'b0b!pass', 'Bob', 'Johnson', 1, false, '2024-02-12', '2024-02-12',
        '+1122334455'),
       ('emily_davis', 'emily.davis@example.com', 'davispass123', 'Emily', 'Davis', 3, true, '2024-02-12', '2024-02-12',
        '+1555666777');
...
VALUES (1, 'Information Technology Courses', 'Real-Time Programming in Java',
       ...
       (2, 'Information Technology Courses', 'Introduction to SQL Essentials',
        '["SQL", "relational databases", "MySQL"]', 'Beginner', '10.06 - 28.06', 2, 20, 'SQL Fundamentals',
       ...
       (3, 'Information Technology Courses', 'Creating Web Application with .Net',
        '["web", "programming", ".net", "C#"]', 'Beginner', '05.08 - 16.08', 4, 40, '.Net Developer Fundamentals',
       ...
       (4, 'Information Technology Courses', 'Azure Cloud Fundamentals', '["Azure", "cloud services"]', 'Beginner',
       ...
       (5, 'Information Technology Courses', 'Azure Administration (Intermediate)',
        '["Azure", "cloud services", "administration"]', 'Intermediate', '02.09 - 20.12', 4, 5,
        ...
        'https://digitaltransformation.org.au/sites/default/files/2022-01/azure.png'),
       (6, 'Information Technology Courses', 'AWS Cloud Practitioner', '["AWS", "cloud services"]', 'Beginner',
       ...
       (7, 'Digital Marketing Courses', 'Search Engine Optimization',
       ...
       (8, 'Digital Marketing Courses', 'Social Media Marketing',
        '["strategic storytelling", "targeted engagement techniques", "data-driven optimization"]', 'Intermediate',
       ...
       (9, 'Business and Entrepreneurship Courses', 'Business Strategy', null, null, '03.06 - 29.11', 10, 10,
       ...
       (10, 'Data Science and Analytics Courses', 'Machine Learning Basics with Python',
        '["Python, machine learning", "programming", "data science"]', 'Beginner', '19.08 - 30.08', 2, 10,
       ...
       (11, 'Data Science and Analytics Courses', 'Image Recognition',
       ...
       (12, 'Data Science and Analytics Courses', 'Databricks fundamentals',
