...
INSERT INTO courses (productID, category, title, level, closest_course_session, course_size, hours_per_week, related_certifications, description, image)
VALUES (
    1,
    'Information Technology Courses',
    'Real-Time Programming in Java',
    ['Java', 'Real-time programming', 'Multithreading', 'Programming'],
    'Expert',
    '03.06 - 28.06',
    7.5,
    40,
    ...
    20,
    'SQL Fundamentals',
    'Dive into the fundamentals of database management with our beginner-level online course, "Introduction to SQL Essentials." Geared towards those new to the world of databases and SQL, this course provides a comprehensive foundation for understanding and utilizing SQL for effective data management. While MySQL is touched upon to broaden your practical knowledge, the core focus is on SQLs universal principles
     applicable across various database systems. Led by seasoned instructors, the course covers database design, querying data, and basic data manipulation using SQL commands. With a hands-on approach, you'll engage in practical exercises to reinforce your learning, ensuring you gain the skills necessary to navigate and interact with databases confidently.
     Whether you're a budding developer, analyst, or anyone eager to harness the power of databases, this course offers an accessible entry point into the world of SQL, setting the stage for your future success in data-driven environments.',
...
(
    ...
    'Intermediate',
    ['keyword research and analysis', 'technical SEO optimization', 'off-page SEO strategies', 'advanced analytics and reporting'],
    '05.08 - 30.08',
    2,
    4,
    'SEO Wizard',
...
(
    ...
    ['strategic storytelling', 'targeted engagement techniques', 'data-driven optimization'],
    'Intermediate',
    '05.08 - 30.08',
    2,
    4,
...
(
    ...
    ['Python', 'Machine Learning', 'Programming', 'Data Science'],
    'Beginner',
    '19.08 - 30.08',
    2,
    10,
...
(
    ...
    'Data Science and Analytics Courses',
    'Image Recognition',
    ['Python', 'Machine Learning', 'Programming', 'data science', 'neural networks', 'image processing'],
    'Intermediate',
    '02.09 - 27.09',
    4,
    20,
