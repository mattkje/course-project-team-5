 ...
 * A role represents a set of permissions and privileges that a user can have.
 * Roles are used to manage access control.
 * Each user can have one or more roles assigned to them.
 * Each role contain an id, a name, and a set of users that have
 * that role.
 */
@Entity(name = "roles")
@Table(name = "roles")
