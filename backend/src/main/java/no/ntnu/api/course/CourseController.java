...
/**
 * The CourseController class is a class for handling HTTP requests
 * for the course API.
 */
@RestController
public class CourseController {
  ...
  public ResponseEntity<?> postKeywordToCourse(@PathVariable int courseId,
                                               @RequestBody Set<Integer> keywordIds) {
    if (userService.isAdmin()) {
  ...
  public Collection<Course> getCoursesWithinDateRange(@RequestParam String startDate,
