...
public class CourseController {
  ...
  public ResponseEntity<?> postKeywordToCourse(
      @PathVariable int courseId, @RequestBody Set<Integer> keywordIds) {
    if (userService.isAdmin()) {
  ...
  public Collection<Course> getCoursesWithinDateRange(
